...
The _Dojot Provider_ is a type of "plugin" created for the [Keycloak](https://www.keycloak.org/)
...
_Dojot Provider_ uses the [Maven](https://docs.jboss.org/author/display/WFLY/Command%20Line%20Interface.html)
...
our _Dojot Provider_ and also creates the modules with the libraries that the
