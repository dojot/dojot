...
const userConfigFile =
  process.env.DEVICE_AUTH_USER_CONFIG_FILE || 'production.conf';
ConfigManager.loadSettings('DEVICE_AUTH', userConfigFile);
const config = ConfigManager.getConfig('DEVICE_AUTH');
...
const logger = new Logger('device-auth:index');
