...
__ATTETION__ It's highly recommended to communicate with Keycloak over HTTPS, visit the session Setting up TLS(SSL) in Keycloak Docker image page for more details.
