...
export class DevicesRepository {
    ...
    async remove(prisma: PrismaClient,id:string)
    {
      try {
        ...
        this.logger.debug('DevicesRepository - remove ', {error:error.message});
      }
    }
     ...
     async findById(prisma: PrismaClient,id: string){
      try {
        ...
        const error = e as Error
        this.logger.debug('DevicesRepository - findById ', {error:error.message});
      }  
    }
    ...
    async remove_associate_templates(prisma: PrismaClient,id:string) {
      ...
      try {
        ...
        const error = e as Error
        this.logger.debug('DevicesRepository - remove_associate_templates ', {eerror:error.message});
      }
    }
