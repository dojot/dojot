...
// const ws = new WebSocket('http://localhost:5000/api/v1/topics/kafka_topic?fields=temperature,a/*/e,foo&where=foo=nin:"a,bc",d,"\\\\,\\n\\"a","\\"";');
// const ws = new WebSocket('http://localhost:5000/api/v1/topics/kafka_topic?fields=temperature,a/*/e&where=foo=in:"a,bc\\n",ab\\n,"\\\\,\\",a";');
// const ws = new WebSocket('http://localhost:5000/api/v1/topics/kafka_topic?fields=temperature,a/*/e&where=data.temperature=lt:30.0;rain=10;bar=neq:20;');
// const ws = new WebSocket('http://localhost:5000/api/v1/topics/kafka_topic?fields=temperature,a/*/e&where=temperature=31.0;a.c.e=nin:a,1,h,2,3;');
