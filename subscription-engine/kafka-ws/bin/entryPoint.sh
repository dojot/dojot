...
readonly KAFKA_WS_CONSUMER_METADATA_BROKER_LIST=${KAFKA_HOSTS:-"kafka:9092"}
...
# Redis parameters
readonly KAFKA_WS_REDIS_HOST=${REDIS_HOST:-"redis"}
readonly KAFKA_WS_REDIS_PORT=${REDIS_PORT:-"6379"}
readonly KAFKA_WS_REDIS_PASSWD=${REDIS_PASSWD:-""}
