...
module.exports = ({ mountPoint, producerMessages }) => {
  ...
  const httpsRoutes = [
    ...
    },
    {
      mountPoint,
      name: 'many-messages',
      path: ['/incoming-messages/create-many'],
      handlers: [
        {
          method: 'post',
          middleware: [
  ...
  const httpRoutes = [
    {
      mountPoint,
      name: 'unsecure-single-message',
      path: ['/unsecure/incoming-messages'],
      handlers: [
        {
          method: 'post',
          middleware: [
    ...
    {
      mountPoint,
      name: 'unsecure-many-messages',
      path: ['/unsecure/incoming-messages/create-many'],
      handlers: [
        {
          method: 'post',
          middleware: [
