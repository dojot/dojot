...
export CERT_CERT_FILE="$V2K_APP_HOSTNAME.crt"
export CERT_KEY_FILE="$V2K_APP_HOSTNAME.key"
export CERT_CSR_FILE="$V2K_APP_HOSTNAME.csr"
...
export certCname=$V2K_APP_HOSTNAME
